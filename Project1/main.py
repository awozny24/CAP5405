...
print()
print("\n##################################################################")
print("############ BEGIN CLASSIFICATION RESULTS FOR "SINGLE" ###########")
print("##################################################################")
print()
print("#################################################")
print("############# Training on All Data ##############")
...
print("############## END CLASSIFICATION RESULTS FOR "SINGLE" ############")
print()
print()
print("\n##################################################################")
print("############ BEGIN CLASSIFICATION RESULTS FOR "FINAL" ###########")
print("##################################################################")
print()
print("#################################################")
print("############# Training on All Data ##############")
print("#################################################")
classifiers.svm('final', dataProp=1.0, print_cmatrix=True, print_acc=True)
classifiers.knn('final', dataProp=1.0, print_cmatrix=True, print_acc=True)
classifiers.mlp('final', dataProp=1.0, print_cmatrix=True, print_acc=True)
print()
print("#################################################")
print("############# Training on 1/10 Data #############")
print("#################################################")
classifiers.svm('final', dataProp=0.1, print_cmatrix=True, print_acc=True)
classifiers.knn('final', dataProp=0.1, print_cmatrix=True, print_acc=True)
classifiers.mlp('final', dataProp=0.1, print_cmatrix=True, print_acc=True)
print("############# END CLASSIFICATION RESULTS FOR "FINAL" ############")
